...
import { A as AstroError, R as RenderUndefinedEntryError, a as createComponent, r as renderTemplate, u as unescapeHTML, U as UnknownContentCollectionError, g as renderUniqueStylesheet, h as renderScriptElement, i as createHeadAndContent, b as renderComponent } from './astro/server_4EYgddpo.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_B3SwK5FC.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    let entries = [];
    if (!Object.assign(__vite_import_meta_env__, { found: 1, Path: process.env.Path })?.DEV && cacheEntriesByCollection.has(collection)) {
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_SsL_lEuJ.mjs').then(n => n._);
